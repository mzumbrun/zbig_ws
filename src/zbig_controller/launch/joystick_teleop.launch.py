...
def generate_launch_description():
    ...
    joy_teleop = Node(
        ...
        parameters=[os.path.join(get_package_share_directory("zbig_controller"), "config", "joy_teleop.yaml"),
    ...
    joy_node = Node(
        ...
        executable="joy_node",
        name="joystick",
        parameters=[os.path.join(get_package_share_directory("zbig_controller"), "config", "joy_config.yaml"),
                    {"use_sim_time": LaunchConfiguration("use_sim_time")}]                    
    )
